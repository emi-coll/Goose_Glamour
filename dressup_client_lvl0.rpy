...
#This is the dressup UI for level 0 - E.C.
screen dress_ui0:
    image "temp backgroundd.PNG"
    image "TestGUI.png" 
...
#For example, headwear1, which is a plush goose, shows a plush goose on the main body and sets the variable headwear_0 to "a112" - EC
...
#Headwear buttons - EC
    ...
    #earrings - EC
    imagebutton auto "headwear4GUI_%s.PNG" align(0.550, 0) action [Show("headwear4"), SetVariable("headwear_0", "a116")] at accessoryzoom1
...
#Coat buttons - EC  
    ...
    #boa - EC
    imagebutton auto "coat4GUI_%s.PNG" align(0.56, 0.25) action [Show("coat4"), SetVariable("coat_0", "a224")] at coatzoom1

#Top/Dress buttons - EC
    #X button - EC
    imagebutton auto "nullGUI_%s.PNG" align (0.95, 0.425) action [Show("topDressNull"), SetVariable("topDress_0", "a000")] at nullzoom
    ...
    #elegant dress - EC
    imagebutton auto "top4GUI_%s.PNG" align(0.55, 0.425) action [Show("topDress4"), SetVariable("topDress_0", "a334")] at coatzoom1
...
#Socks/Tights buttons - EC
    ...
    #elegant socks - EC
    imagebutton auto "socks4GUI_%s.PNG" align(0.550, 0.6) action [Show ("socksTights4"), SetVariable("socksTights_0", "a445")] at coatzoom1
...
#Shoes buttons - EC
    ...
    #elegant shoes - EC
    imagebutton auto "shoes4GUI_%s.PNG" align(0.550, 0.8) action [Show("shoes4"), SetVariable("shoes_0", "a552")] at coatzoom1
...
#Accessory buttons - EC
    ...
    #elegant purse - EC
    imagebutton auto "accessory4GUI_%s.PNG" align (0.550, 1.0) action [Show("accessory4"), SetVariable("accessory_0", "a905")] at accessoryzoom1