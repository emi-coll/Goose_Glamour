...
# PV = Point Value
# This is how each of the item's point values are assigned
# "Category Names" = [Cute PV, Goth PV, Casual PV, Formal PV, Elegant PV, Active PV]
...
# Choice of TopsDresses

a331 = [3,	-5,	5,	1,	-1,	4]
a332 = [2,	5,	-2,	-2,	2,	-5]
a333 = [1,	0,	1,	5,	3,	0]

# Choice of Socks/Tights
...
# The following itemlist includes all of the items in the game with their 
...
# The following itemlist includes all of the names for each item in the game
...
def points(Accessories, Headwear, Coats, TopsDresses, SocksTights, Shoes):
    ...
    # These "if" statements uses the user's item name input, and assigns
    # the point values of the item chosen to a new variable using itemlist1
    ...
    # The following variables calculate the total point value for each 
    # category, respectively. It uses each item's given point values from the
    # code above and indexes them and adds all the respective values together
    ...
    # This function returns a list with the total point values of each category
...
def rank(FinalPoints):
    ...
    # A while loop which checks every categories total point value and assigns
    # a letter score to a new list based on how high the point value is 
    ...
    # This function returns a new list with a letter score for each category
    # respectively
...
def calculate_points():
    ...
    # Asking the user for the item name for each wearable
    ...
    # Uses "points" function and "rank" function to create a new list
    # which has the letter score for each category.
    
    FinalPoints = points(Q1, Q2, Q3, Q4, Q5, Q6)
    FinalRank = rank(FinalPoints)
    
    # Prints out the letter score for its respective category
...
# Runs the calculation for the score of each category
