...
#For example, headwear1, which is a plush goose, shows a plush goose on the main body and sets the variable headwear_4 to "a112" - EC
...
#Headwear buttons - EC
    ...
    #earrings - EC
    imagebutton auto "headwear4GUI_%s.PNG" align(0.550, 0) action [Show("headwear4"), SetVariable("headwear_4", "a116")] at accessoryzoom1
    
    #hardhat - EC
    imagebutton auto "headwears1GUI_%s.PNG" align (0.88, 0.05) action [Show("headwears1"), SetVariable("headwear_4", "a")] at coatzoom1
    #opera monocle - EC
    imagebutton auto "headwears2GUI_%s.PNG" align (0.825, 0) action [Show("headwears2"), SetVariable("headwear_4", "a1")] at coatzoom1
    #rubber duck - EC
    imagebutton auto "headwears3GUI_%s.PNG" align (0.750, 0) action [Show("headwears3"), SetVariable("headwear_4", "a2")] at coatzoom1
...
#Coat buttons - EC
    ...
    #boa - EC
    imagebutton auto "coat4GUI_%s.PNG" align(0.56, 0.25) action [Show("coat4"), SetVariable("coat_4", "a224")] at coatzoom1

#Top/Dress buttons - EC
    #X button - EC
    imagebutton auto "nullGUI_%s.PNG" align (0.95, 0.425) action [Show("topDressNull"), SetVariable("topDress_4", "a000")] at nullzoom
    ...
    #elegant dress - EC
    imagebutton auto "top4GUI_%s.PNG" align(0.55, 0.425) action [Show("topDress4"), SetVariable("topDress_4", "a334")] at coatzoom1
...
#Socks/Tights buttons - EC
    ...
    #elegant socks - EC
    imagebutton auto "socks4GUI_%s.PNG" align(0.550, 0.6) action [Show ("socksTights4"), SetVariable("socksTights_4", "a445")] at coatzoom1
...
#Shoes buttons - EC
    ...
    #elegant shoes - EC
    imagebutton auto "shoes4GUI_%s.PNG" align(0.550, 0.8) action [Show("shoes4"), SetVariable("shoes_4", "a552")] at coatzoom1
...
#Accessory buttons - EC
    ...
    #elegant purse - EC
    imagebutton auto "accessory4GUI_%s.PNG" align (0.550, 1.0) action [Show("accessory4"), SetVariable("accessory_4", "a905")] at accessoryzoom1

    #green dot - EC
    imagebutton auto "accessorys1GUI_%s.PNG" align(0.85, 0.96) action [Show("accessorys1"), SetVariable("accessory_4", "a910")] at accessoryzoom1