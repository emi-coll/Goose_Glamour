...
#Headwear buttons
    ...
    imagebutton auto "headwears1GUI_%s.PNG" align (0.90, 0) action [Show("headwears1"), SetVariable("headwear_3", "a")] at headwearzoom1
    imagebutton auto "headwears2GUI_%s.PNG" align (0.825, 0) action [Show("headwears2"), SetVariable("headwear_3", "a1")] at headwearzoom1
...
#Top/Dress buttons
    imagebutton auto "nullGUI_%s.PNG" align (0.95, 0.45) action [Show("topDressNull"), SetVariable("topDress_3", "a000")] at nullzoom
...
#Accessory buttons
    ...
    imagebutton auto "accessorys1GUI_%s.PNG" align(0.85, 0.96) action [Show("accessorys1"), SetVariable("accessory_3", "a")] at accessoryzoom1